...
class Comment(models.Model):
    author = models.ForeignKey('oauth.Ouser', related_name='%(class)s_related',
                               verbose_name='评论人', on_delete=models.CASCADE)

    # 使用 related_name来升级使用 _set查询
...
class ArticleComment(Comment):
    belong = models.ForeignKey(Article, related_name='article_comments',
                               verbose_name='所属文章', on_delete=models.CASCADE)
