...
class Tag(models.Model):
    ...
    slug = models.SlugField(unique=True)  # django中的url链接优化, 点击时, 空格不必转成 %20
...
class Article(models.Model):
    IMG_LINK = '/static/blog/img/summary.png'  # 一张骇客图 默认不传图片显示这个
    author = models.ForeignKey('oauth.Ouser', verbose_name='作者', on_delete=models.PROTECT)
